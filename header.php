<!-- Nom page : header
Description : Cette page présente le site, appel le fichier CSS et défini les caractères spéciaux "UTF-8"
Nom de l'auteur : Rémi Hillériteau -->
<meta charset='UTF-8' />
<link rel='stylesheet' href='http://localhost/infirmerie/style.css' />
